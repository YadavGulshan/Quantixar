...
//  max_nb_conn   ef_cons    ef_search   scale_factor    extend  keep pruned  recall        req/s
// last ratio
//
//     12           400         12           1              0          0        0.917        6486
// 1.005     24           400         24           1              1          0        0.9779
// 3456       1.001

// parallel mode 4 i7-core @2.7Ghz
//  max_nb_conn   ef_cons    ef_search   scale_factor    extend  keep pruned  recall        req/s
// last ratio     24           400         24           1              0          0        0.977
// 12566       1.001     24           400         12           1              0          0
// 0.947        18425       1.003

// 8 hyperthreaded i7-core @ 2.3 Ghz
//     24           400         24           1              0          0        0.977        22197
// 1.001

// 24 core Core(TM) i9-13900HX simdeez
//     24           400         24           1              0          0        0.977        62000
// 1.001
...
pub fn main() {
  ...
  for i in 0..anndata.test_data.len() {
    ...
    let knn_neighbours_dist: Vec<f32> =
      knn_neighbours_for_tests[i].iter().map(|p| p.distance).collect();
