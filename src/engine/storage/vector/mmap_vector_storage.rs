...
mod tests {
    ...
    use crate::engine::storage::vector::mmap_vector_storage::{
    ...
    fn test_basic_persistence() {
...

        {
            ...
            let db = StorageManager::new(dir2.path(), &[DB_VECTOR_CF])
                .db_column_wrapper
                .database;
            let storage2 =
                open_simple_vector_storage(db, DB_VECTOR_CF, 4, Distance::DotProduct).unwrap();
            {
