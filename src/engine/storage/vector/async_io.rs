...
/// [UringReader] is designed to facilitate efficient, asynchronous file I/O operations using io_uring, a high-performance I/O interface for Linux
/// Its primary purpose is to read data from a file asynchronously, minimizing I/O latency and maximizing throughput,
/// especially beneficial in applications requiring high-speed data processing.
...
mod tests {
  ...
  fn test_successful_read() {
    ...
    let mut reader = UringReader::new(file, raw_size, header_size).expect("Failed to create UringReader");
    ...
    reader.read_stream(point_offsets, |idx, point_id, data| {
